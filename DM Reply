...
namespace Discord_Bot
{
    class Program
    {
        ...
        private async Task MessageReceivedAsync(SocketMessage message){
            ...
            await message.Channel.SendMessageAsync("Yes, this is dm");
            }
        }
        //DM Your own bot and type ;dm. Expect your bot to reply Yes, this is dm.
        //Please mark that the bot will reply to all commands(Including Server commands) in DM. This code is only specific for DM Channels.
