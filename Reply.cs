    ...
    class Program
    {
        ...
        private async Task MessageReceivedAsync(SocketMessage message)
        {
            ...
            if(message.Content == ";Hello")
            {
                ...
                await message.AddReactionAsync(tick);
            }
        }
    }
}
//Run this code and expect your bot to go online. Try entering ;Hello. Your discord bot should send Hi! I am a Discord Bot!. Also, the bot will also
//add a tick on your message
